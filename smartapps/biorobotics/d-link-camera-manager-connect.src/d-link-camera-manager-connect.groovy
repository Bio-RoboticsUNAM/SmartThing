    ...
    page(name: "mainPage", title: "Existing Cameras", install: true, uninstall: true) {
        if(state?.installed) {
            section("Add a New Camera") {
                app "Dlink Video Camera Child", "biorobotics", "Dlink Video Camera Child", title: "New Fixed D-Link Camera", page: "mainPage", multiple: true, install: true
                app "Dlink PTZ Video Camera Child", "biorobotics", "Dlink PTZ Video Camera Child", title: "New PTZ D-Link Camera", page: "mainPage", multiple: true, install: true
            }
        } else {
